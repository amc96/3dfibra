...
const INITIAL_PLANS: InsertPlan[] = [
  ...
  },
  {
    ...
    speed: "200+ Canais",
    price: "53,90",
    features: ["Canais abertos entre outros", "Qualidade HD", "Suporte para TV, iOS, Android e Web", "Brozo", "TV Pampa", "SBT", "RECORD", "BAND", "TRAVEL", "TV BLITS", "Planalto Norte", "GAZETA", "VRT", "DOCS", "Unique", "Artel", "Trace Brazuca", "Trace Latina", "Trace Urban", "TV História", "Music Box Brazil", "Home & Health", "TLC", "Food Network", "Int Novelas", "Rai Italia", "Adult Swim", "Sabor & Arte", "TV Justiça", "TV Brasil", "RESERVADO COMUNITÁRIO", "TV Senado", "TV Câmara", "RedeTV", "New", "TVD News", "Euro News", "Band News", "RN", "CNN Brasil", "Telesur", "Exitosa", "JP News", "Fox News", "Bloomberg", "CNBC", "Times Now", "Mider", "LMC", "Retro", "Ultra", "Family Series", "Movies", "Prime Box Brazil", "Film & Arts", "AMC", "ISTV", "Canal Sony", "TNT Series", "Space", "TCM HD", "Cinemax", "Lifetime HD", "Top Action", "Kios", "ID", "Otaku", "Leo & Lully", "Yupi", "Hallo!", "Discovery Kids", "Cartoon Network", "Tooncast", "Cartoonito", "Fish TV", "Unique Sports", "Cazé TV", "Band Sports HD", "Fuel TV", "ESPN", "ESPN 2", "ESPN 3", "ESPN 4", "ESPN 5", "TNT Sports", "Trace Sport Stars", "Canal Rural", "AgroBrasil", "Terra Viva", "AgroCanal", "Canal do Boi", "Discovery", "Animal Planet", "Discovery Turbo", "Discovery Science", "Discovery Theater", "Discovery World", "HGTV", "History", "TV Cultura", "Tvescala", "RESERVADO UNIVERSITÁRIO", "SescTV", "TV Mundo Maior", "Canção Nova", "Rede Vida", "RS21", "TV Evangelizar", "Novo Tempo", "EWTN", "Rede Gênesis", "NHK"],
    category: "tv",
    isHighlighted: true
  },
  {
